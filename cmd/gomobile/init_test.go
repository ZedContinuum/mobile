...
go install -x github.com/ZedContinuum/mobile/gl
go install -x github.com/ZedContinuum/mobile/app
go install -x github.com/ZedContinuum/mobile/exp/app/debug{{end}}
