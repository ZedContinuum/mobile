...
To install:
	...
	$ go get github.com/ZedContinuum/mobile/cmd/gomobile
	$ gomobile init
...
install with mobile apps using the github.com/ZedContinuum/mobile/exp/audio/al package.
...
create a gradle subproject and configure the gobind plugin in the build.gradle file:
	...
	gobind {
		...
		pkg = "github.com/ZedContinuum/mobile/example/bind/hello"
...
main Android project build.gradle, apply the gobind plugin after the android plugin:
	...
	gobind {
		pkg = "github.com/ZedContinuum/mobile/example/bind/reverse"
	}

*/
package main // import "github.com/ZedContinuum/mobile/cmd/gomobile"
