...
import (
	...
	"github.com/ZedContinuum/mobile/bind"
	"github.com/ZedContinuum/mobile/internal/importers"
	"github.com/ZedContinuum/mobile/internal/importers/java"
	"github.com/ZedContinuum/mobile/internal/importers/objc"
)
...
func (b *binder) GenGoSupport(outdir string) error {
	bindPkg, err := ctx.Import("github.com/ZedContinuum/mobile/bind", "", build.FindOnly)
	if err != nil {
		return err
	}
...
func (b *binder) GenObjcSupport(outdir string) error {
	objcPkg, err := ctx.Import("github.com/ZedContinuum/mobile/bind/objc", "", build.FindOnly)
	if err != nil {
		return err
	}
...
func (b *binder) GenJavaSupport(outdir string) error {
	javaPkg, err := ctx.Import("github.com/ZedContinuum/mobile/bind/java", "", build.FindOnly)
	if err != nil {
		return err
	}
