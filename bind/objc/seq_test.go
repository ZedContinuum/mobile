...
func TestObjcSeqTest(t *testing.T) {
	runTest(t, []string{
		"github.com/ZedContinuum/mobile/bind/testpkg",
		"github.com/ZedContinuum/mobile/bind/testpkg/secondpkg",
		"github.com/ZedContinuum/mobile/bind/testpkg/simplepkg",
...
func TestObjcSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/ZedContinuum/mobile/bind/benchmark"}, "xcodebench", "SeqBench.m", true)
}

// TestObjcSeqWrappers runs ObjC test SeqWrappers.m.
// This requires the xcode command lines tools.
func TestObjcSeqWrappers(t *testing.T) {
	runTest(t, []string{"github.com/ZedContinuum/mobile/bind/testpkg/objcpkg"}, "xcodewrappers", "SeqWrappers.m", false)
}
...
func runTest(t *testing.T, pkgNames []string, project, testfile string, dumpOutput bool) {
	...
	if _, err := run("which gomobile"); err != nil {
		...
		if _, err := run("go install github.com/ZedContinuum/mobile/cmd/gomobile"); err != nil {
